...
const biuldDom = (surahArabic, surahEnglish, surahNumber) => {
    ...
    <div class="surah-info">
        <div class="surah-names">
            <a href="http://127.0.0.1:5502/day1/tafsir.html?id=${surahNumber}" id="surah-en">${surahEnglish}</a>
            <a href="http://127.0.0.1:5502/day1/tafsir.html?id=${surahNumber}" id="surah-ar">${surahArabic}</a>
        </div>
